...
public class TestFacturaPDFAction extends MockStrutsTestCase{

	private static String	idfactura	= "1";

	public TestFacturaPDFAction( String testName ) {
	...
	public void setUp() throws Exception{
		...
		TestFacturaPDFAction.idfactura = fac.get(0).getId().toString();
	}

	@Test
	public void testSuccessPDFFactura() throws Exception{

		setRequestPathInfo("/FacturaPDFAction");
		
		GestionFacturasForm frm = new GestionFacturasForm();

		frm.setId(TestFacturaPDFAction.idfactura);
	...
	@Test
	public void testSuccessPDFFacturaWrongIdFactura() throws Exception{
	...
	public static void main( String[] args ){
		...
		junit.textui.TestRunner.run(TestFacturaPDFAction.class);
	}
