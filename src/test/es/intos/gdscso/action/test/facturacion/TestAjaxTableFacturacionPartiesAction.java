...
public class TestAjaxTableFacturacionPartiesAction extends MockStrutsTestCase{

	private static final String	yearOfTest			= "2012";

	public TestAjaxTableFacturacionPartiesAction( String testName ) {
	...
	@Test
	public void testAjaxFacturacionPartides(){

		setRequestPathInfo("/AjaxTableFacturacionPartidesAction");
		
		addRequestParameter("idany", TestAjaxTableFacturacionPartiesAction.yearOfTest);
	...
	public void testAjaxFacturacionPartidesNUllParam() throws Exception{
...
try{
		junit.textui.TestRunner.run(TestAjaxTableFacturacionPartiesAction.class);
}catch(Exception e){
	e.getCause();
}
	}
