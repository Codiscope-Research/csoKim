...
public class TestFacturacionPartidasAction extends MockStrutsTestCase{

	public TestFacturacionPartidasAction( String testName ) {
	...
	public void testSuccessSearch(){
		...
		setRequestPathInfo("/FacturacionPartidasAction");
		actionPerform();
		verifyForward("Success");
		verifyForwardPath("/web/pantallas/facturacion/facturacionPartidas.jsp");
	...
	public static void main( String[] args ){
		...
		junit.textui.TestRunner.run(TestFacturacionPartidasAction.class);
	}
