...
public class TestAjaxTableDetallPartidaAction extends MockStrutsTestCase{

	private static final String	yearOfTest			= "2012";
	private static final String	csoOfTest			= "1";
	private static final String	partidaOfTest			= "1";

	public TestAjaxTableDetallPartidaAction( String testName ) {
	...
	public void testAjaxWithForm(){
		...
		setRequestPathInfo("/AjaxTableDetallPartidaAction");
		
		addRequestParameter("idany", TestAjaxTableDetallPartidaAction.yearOfTest);
		addRequestParameter("idPartida", TestAjaxTableDetallPartidaAction.partidaOfTest);		
		addRequestParameter("idcso", TestAjaxTableDetallPartidaAction.csoOfTest);
	...
	public void testAjaxWithNullParams() throws Exception{
		...
		addRequestParameter("idcso", "null");
		addRequestParameter("idPartida", "null");	
		addRequestParameter("sEcho", "0");
		addRequestParameter("iDisplayLength", "20");
		addRequestParameter("iDisplayStart", "0");
	...
	public static void main( String[] args ){
		...
		junit.textui.TestRunner.run(TestAjaxTableDetallPartidaAction.class);
