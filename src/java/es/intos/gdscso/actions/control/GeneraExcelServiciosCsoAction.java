...
public class GeneraExcelServiciosCsoAction extends LogadoBaseAction{
	...
	protected ActionForward executeLogadoAction( ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		GestionFacturasGeneraExcelForm frm = (GestionFacturasGeneraExcelForm) form;
		GeneraExcelServiciosCso excel = new GeneraExcelServiciosCso("excel.control.sheet", user, missatges, locale);
