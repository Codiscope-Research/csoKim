...
import es.intos.gdscso.actions.facturacion.ctrl.AjaxTableDetallPartidaCtrl;
import es.intos.gdscso.exceptions.ErrorParamsException;
import es.intos.gdscso.utils.Utils;
import es.intos.util.Usuario;

public class AjaxTableDetallPartidaAction extends LogadoBaseAction{
	...
	public ActionForward executeLogadoAction( ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		String result = "";
		AjaxTableDetallPartidaCtrl ctrl = new AjaxTableDetallPartidaCtrl();
		try {
