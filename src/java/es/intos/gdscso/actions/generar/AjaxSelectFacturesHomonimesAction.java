...
import es.intos.gdscso.actions.generar.ctrl.AjaxSelectFacturesHomonimesCtrl;
import es.intos.gdscso.exceptions.ErrorParamsException;
import es.intos.gdscso.utils.Utils;
import es.intos.util.Usuario;

public class AjaxSelectFacturesHomonimesAction extends LogadoBaseAction{
	...
	public ActionForward executeLogadoAction( ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		String result = "";
		AjaxSelectFacturesHomonimesCtrl ctrl = new AjaxSelectFacturesHomonimesCtrl();
	...
	private void InicializeParam( HttpServletRequest request ) throws Exception{
